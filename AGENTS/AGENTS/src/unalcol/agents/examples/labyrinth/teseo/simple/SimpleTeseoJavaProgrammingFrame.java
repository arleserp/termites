...
//      agent.setCommands( sb.toString() );
  ...
  public void jCompileButton_actionPerformed(ActionEvent actionEvent) {
    ...
    sb.append( "\n}\n" );
    String fileName = javaEnv.appropiatedPath("classes/TheAgentProgram");
    ...
    compiler.addClassPath(pathName+"lib/unalcol_core.jar");
    compiler.addClassPath(pathName+"lib/unalcol_sort.jar");
    compiler.addClassPath(pathName+"lib/unalcol_structures.jar");
    compiler.addClassPath(pathName+"lib/unalcol_agents.jar");
    try{
      String msg = compiler.compile(fileName + ".java");
      ...
      if (msg == null) {
        ...
        this.theLogPanel.getErrorArea().setText(msg);
      }
    }catch( Exception e ){
