...
java  -Xmx4200m -classpath TermitesSimulator.jar unalcol.termites.boxplots.InformationCollected1 ..\results Gomez levywalk lwphevap hybrid sequential random 
...
java  -Xmx4200m -classpath TermitesSimulator.jar unalcol.termites.boxplots.RoundNumber1 ..\results Gomez levywalk lwphevap hybrid sequential random 
...
REM java  -Xmx4200m -classpath TermitesSimulator.jar unalcol.termites.boxplots.HybridInformationCollected ..\results Gomez levywalk lwphevap hybrid sequential random 
...
java  -Xmx4200m -classpath TermitesSimulator.jar unalcol.termites.boxplots.SucessfulRates ..\results Gomez levywalk lwphevap hybrid sequential random 
...
java  -Xmx4200m -classpath TermitesSimulator.jar unalcol.termites.boxplots.HybridGlobalInfoReport ..\results Gomez levywalk lwphevap hybrid sequential random 
...
java  -Xmx4200m -classpath TermitesSimulator.jar unalcol.termites.boxplots.MessagesSent1 ..\results Gomez levywalk lwphevap hybrid sequential random 
...
java  -Xmx4200m -classpath TermitesSimulator.jar unalcol.termites.boxplots.BestAgentsRoundInfoCollected ..\results Gomez levywalk lwphevap hybrid sequential random 
...
java  -Xmx4200m -classpath TermitesSimulator.jar unalcol.termites.boxplots.BestAgentsPercentageInfoCollected ..\results Gomez levywalk lwphevap hybrid sequential random 
