 ...
 */
public class WorldTemperaturesOneStepOnePheromoneEvaporationMapImpl extends World {
    ...
    public WorldTemperaturesOneStepOnePheromoneEvaporationMapImpl(Vector<Agent> agents, int w, int h) {
        super(agents, w, h);
        width = w;
    ...
    public boolean act(Agent agent, Action action) {
        ...
        if (AppMain.walls.equals("wallsoff")) {
            ...
            executed = updatePiecesInWorldNotToroidal(t,this.getActionIndex(act));// getMovement(t, x));//this.getActionIndex(act));
        }
        DrawPieceInWorld(t);
        //showMap();
        return executed;
