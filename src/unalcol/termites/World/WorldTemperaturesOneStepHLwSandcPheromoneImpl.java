 ...
 */
public class WorldTemperaturesOneStepHLwSandcPheromoneImpl extends World {
    ...
    public WorldTemperaturesOneStepHLwSandcPheromoneImpl(Vector<Agent> agents, int w, int h) {
        super(agents, w, h);
        width = w;
    ...
    public boolean act(Agent agent, Action action) {
        ...
        if (!((Hashtable) t.getAttribute("inf_i")).containsKey(loc)) {
            ...
            if (((HLwSandCPheromoneProgramPfImpl) t.getProgram()).isStrategySandc()) {
            ...
            ((HLwSandCPheromoneProgramPfImpl) t.getProgram()).RewardStrategy();
        }
