 ...
 */
public class WorldTemperaturesOneStepLWOnePheromoneEvaporationImpl extends World {
    ...
    public WorldTemperaturesOneStepLWOnePheromoneEvaporationImpl(Vector<Agent> agents, int w, int h) {
        super(agents, w, h);
        width = w;
    ...
    public boolean act(Agent agent, Action action) {
        ...
        if (!((Hashtable) t.getAttribute("inf_i")).containsKey(loc)) {
            ...
            t.setRoundsWithoutNewInfo(0);
        } else {
            t.addRoundsWithoutNewInfo();
        }
...
//        if (t.getRoundsWithoutNewInfo() > 100) {
//            System.out.println("t: " + t.getId() + ", rounds without new information: " + t.getRoundsWithoutNewInfo() + " round number:" + t.getRound() + " amount info: " + aminfo + ", wsize: " + width * height);
