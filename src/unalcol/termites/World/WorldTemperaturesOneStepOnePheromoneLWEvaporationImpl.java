 ...
 */
public class WorldTemperaturesOneStepOnePheromoneLWEvaporationImpl extends World {
    ...
    public WorldTemperaturesOneStepOnePheromoneLWEvaporationImpl(Vector<Agent> agents, int w, int h) {
        super(agents, w, h);
        width = w;
