 ...
 */
public class WorldTemperaturesOneStepOnePheromoneImpl extends World {
    ...
    public WorldTemperaturesOneStepOnePheromoneImpl(Vector<Agent> agents, int w, int h) {
        super(agents, w, h);
        width = w;
