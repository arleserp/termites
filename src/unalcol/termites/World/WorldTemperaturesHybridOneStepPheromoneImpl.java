 ...
 */
public class WorldTemperaturesHybridOneStepPheromoneImpl extends World {
    ...
    public WorldTemperaturesHybridOneStepPheromoneImpl(Vector<Agent> agents, int w, int h) {
        super(agents, w, h);
        width = w;
    ...
    public boolean act(Agent agent, Action action) {
        ...
        System.out.println("add" + gotNewInfo);
