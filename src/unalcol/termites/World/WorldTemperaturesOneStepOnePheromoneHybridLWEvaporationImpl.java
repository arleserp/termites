 ...
 */
public class WorldTemperaturesOneStepOnePheromoneHybridLWEvaporationImpl extends World {
    ...
    public WorldTemperaturesOneStepOnePheromoneHybridLWEvaporationImpl(Vector<Agent> agents, int w, int h) {
        super(agents, w, h);
        width = w;
    ...
    public void updateSandC() {
        ...
        for (int k = 0; k < this.getAgents().size(); k++) {
            ...
            if ((this.getAgent(k)).status != Action.DIE) {
                ...
                if (((HybridPheromoneLevyWalkProgramImpl) t.getProgram()).isStrategyCarrier()) {
                    carriers++;
                } else {
                    seekers++;
                }
    ...
    public boolean act(Agent agent, Action action) {
        ...
        ((HybridPheromoneLevyWalkProgramImpl) t.getProgram()).addHistory(gotNewInfo);
        return executed;
    }
