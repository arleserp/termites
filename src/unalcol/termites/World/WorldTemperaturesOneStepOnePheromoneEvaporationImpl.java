 ...
 */
public class WorldTemperaturesOneStepOnePheromoneEvaporationImpl extends World {
    ...
    public WorldTemperaturesOneStepOnePheromoneEvaporationImpl(Vector<Agent> agents, int w, int h) {
        super(agents, w, h);
        width = w;
