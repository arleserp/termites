 ...
 */
public class SeekersandCarriersLevyWalkProgramPfImpl extends TermitesMovementProgram {
...
//    TermitesVM termitesvm = new TermitesVMImpl();
     ...
     */
    public SeekersandCarriersLevyWalkProgramPfImpl(TermitesLanguage _language, WorldConsensusImpl world, int iterator, float probFailure, int failuresByTermite) {
        super(_language, 0);
        this.world = world;
