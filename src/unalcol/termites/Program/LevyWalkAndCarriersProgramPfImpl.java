 ...
 */
public class LevyWalkAndCarriersProgramPfImpl extends TermitesMovementProgram {
...
//    TermitesVM termitesvm = new TermitesVMImpl();
    ...
    public LevyWalkAndCarriersProgramPfImpl(TermitesLanguage _language, WorldConsensusImpl world, int iterator, float probFailure, int failuresByTermite) {
        super(_language, 0);
        this.world = world;
