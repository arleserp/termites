 ...
 */
public class OnlySeekersLevyWalkProgramImpl2 extends TermitesMovementProgram {
...
//    TermitesVM termitesvm = new TermitesVMImpl();
     ...
     */
    public OnlySeekersLevyWalkProgramImpl2(TermitesLanguage _language, WorldConsensusImpl world, int iterator, float probFailure, int failuresByTermite) {
        super(_language, 0);
        this.world = world;
