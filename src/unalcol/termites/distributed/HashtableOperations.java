...
public class HashtableOperations {
    ...
    public static int Maximum(Hashtable A) {
        if (!A.isEmpty()) {
            ...
            return (Integer) Collections.max(A.values());
        } else {
    ...
    public static int Minimum(Hashtable A) {
        if (!A.isEmpty()) {
            //System.out.println("A" + A);
            return (Integer) Collections.min(A.values());
        } else {
    ...
    public static Hashtable JoinSetsK(Hashtable A, Hashtable B) {
        ...
        for (Iterator<int[]> iterator = B.keySet().iterator(); iterator.hasNext();) {
    ...
    public static boolean isCutPoint(Hashtable h) {
        int count = 0;
        int i = 0;
        ArrayList<String> bicon = new ArrayList<String>();
